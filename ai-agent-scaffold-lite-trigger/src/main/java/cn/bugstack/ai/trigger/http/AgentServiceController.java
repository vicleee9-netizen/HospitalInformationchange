...
import cn.bugstack.ai.domain.business.service.IUserInteractionService;
...
public class AgentServiceController implements IAgentService {
    ...
    public Response<CreateSessionResponseDTO> createSession(@RequestBody CreateSessionRequestDTO requestDTO) {
        try {
            ...
            UserInformationEntity userInformation = UserInformationEntity.of(requestDTO.getUserId());
            String sessionId = userInteractionService.createSession(userInformation, requestDTO.getAgentId());
    ...
    public Response<ChatResponseDTO> chat(@RequestBody ChatRequestDTO requestDTO) {
        try {
            ...
            UserInformationEntity userInformation = UserInformationEntity.of(requestDTO.getUserId());
            List<String> messages = userInteractionService.handleMessage(
                    userInformation,
    ...
    public ResponseBodyEmitter chatStream(@RequestBody ChatRequestDTO requestDTO) {
        ...
        try {
            ...
            UserInformationEntity userInformation = UserInformationEntity.of(requestDTO.getUserId());
            Flowable<String> responseStream = userInteractionService.handleMessageStream(
                    userInformation,
                    requestDTO.getAgentId(),
                    requestDTO.getSessionId(),
                    requestDTO.getMessage());
